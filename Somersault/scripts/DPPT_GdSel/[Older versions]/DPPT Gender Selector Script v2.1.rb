#==============================================================================#
#                          DPPT GENDER SELECTOR SCENE v2.1                     #
#                                (by A.Somersault)                             #
#==============================================================================#
...
GENDERFEMALE = PATH + "Dawn.png"       #name of the female graphic.
GENDERMALE   = PATH + "Lucas.png"      #name of the male graphic.
...
class DpptGdSelScene < SMScreen
  def initialize
    ...
    #FEMALE TRAINER    
    addObj("girl",FEMALEX,FEMALEY,GENDERFEMALE)
    @objectsList["girl"].set_src_rect(0,0,FRAMEWIDTH_F,FRAMEHEIGHT_F)

    #MALE TRAINER
    addObj("boy",MALEX,MALEY,GENDERMALE)

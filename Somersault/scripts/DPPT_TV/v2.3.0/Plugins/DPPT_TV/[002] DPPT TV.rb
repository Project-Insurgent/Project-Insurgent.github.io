#==============================================================================#
#                              DPPT TV SCRIPT v2.3.0                           #
#                               (by S.A.Somersault)                            #
#==============================================================================#
# A script that implements a gen 4 styled TV script!                           #
# IMPORTANT: NEEDS SUSc v5.3.0+ in order to work properly                      #
#==============================================================================#
...
class DpptTV_View < SMModuleView
  ...
  def initialize(mod,ctrl=nil)
    ...
    @panels[:MAIN_PANEL].insertObj("lines",AnimatedPlane.new(@panels[:MAIN_PANEL].viewport))
    @panels[:MAIN_PANEL].list["lines"].bitmap = Bitmap.new(@path+"TVLines")
    @panels[:MAIN_PANEL].addObj("TV","TV")
    fitInViewports
    deactivate
  end
  
  def execute; @panels[:MAIN_PANEL].list["lines"].oy += 1 if @mod.getCounter%BARS_SPEED==0; end
end
#==============================================================================#
#==============================================================================#
#                                 DPPT TV MODULE                               #

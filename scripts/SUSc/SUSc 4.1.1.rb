#==============================================================================#
#                      SOMERSAULT'S UTILITIES SCRIPT v4.1.1                    #
#                              Give credit if used                             #
#==============================================================================#
...
class SMSprite < SMObject
 ...
 #GETTERS:
  ...
  def set_zoom_x(val,relOX=@sprite.x)
    @sprite.zoom_x = val
    @sprite.x = @x * val #relOX + (@sprite.x - relOX)
    
    for i in @objectsList.keys; @objectsList[i].set_zoom_x(val,@sprite.x); end
  end
  
  def set_zoom_y(val,relOY=@sprite.y)
    @sprite.zoom_y = val
    @sprite.y = @y * val #relOY + (@sprite.y - relOY)
    
    for i in @objectsList.keys; @objectsList[i].set_zoom_y(val,@sprite.y); end
  end

...
class Scene_Chapter < SMScreen
  ...
  def pbUpdate
    ...
    FADE_IN_TEXT.times do
      pbWait(1)
      Graphics.update
       @objectsList["Chapter"].opacity=@objectsList["Chapter"].opacity+255/FADE_IN_TEXT
    end
    ...
    FADE_OUT_TEXT.times do
      pbWait(1)
      Graphics.update
      @objectsList["Chapter"].opacity=@objectsList["Chapter"].opacity-255/FADE_OUT_TEXT
    end

...
#                                  PARAMETERS
#===============================================================================
GS_PATH = "Graphics/Pictures/GenderSel/"  #general path for both sprites

GENDERFEMALE = "Dawn.png"       #name of the female graphic.
GENDERMALE   = "Lucas.png"       #name of the male graphic.
